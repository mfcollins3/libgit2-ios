...
let package = Package(
	...
	targets: [
		.binaryTarget(
			name: "libgit2",
			url: "https://github.com/mfcollins3/libgit2-ios/releases/download/untagged-b58ada0c5342c46795b6/libgit2.zip",
		...
		.binaryTarget(
			name: "libssl",
			url: "https://github.com/mfcollins3/libgit2-ios/releases/download/untagged-b58ada0c5342c46795b6/libssl.zip",
			checksum: "bead2f809a7b053b301a48b53a03e3d34bcec0ae130d968df4dc78ac66be326a"
		),
		.binaryTarget(
			name: "libcrypto",
			url: "https://github.com/mfcollins3/libgit2-ios/releases/download/untagged-b58ada0c5342c46795b6/libcrypto.zip",
